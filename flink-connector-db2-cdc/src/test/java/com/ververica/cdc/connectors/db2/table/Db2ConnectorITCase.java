...
//            statement.execute("DELETE FROM DB2INST1.PRODUCTS WHERE ID=111;");
    ...
    public void testAllTypes() throws Exception {
        ...
        List<String> expected =
                Arrays.asList(
                        "+I(1,32767,65535,2147483647,5.5,6.6,123.12345,404.4,Hello World,a,abc,2020-07-17T18:00:22.123,2020-07-17,18:00:22,500)",
                        "-U(1,32767,65535,2147483647,5.5,6.6,123.12345,404.4,Hello World,a,abc,2020-07-17T18:00:22.123,2020-07-17,18:00:22,500)",
                        "+U(1,0,65535,2147483647,5.5,6.6,123.12345,404.4,Hello World,a,abc,2020-07-17T18:00:22.123,2020-07-17,18:00:22,500)");
        List<String> actual = TestValuesTableFactory.getRawResults("sink");
    ...
    public void testStartupFromLatestOffset() throws Exception {
        ...
        try (Connection connection = getJdbcConnection();
            ...
            statement.execute(
                    "INSERT INTO DB2INST1.PRODUCTS VALUES (110,'jacket','water resistent white wind breaker',0.2)"); // 110
            statement.execute(
